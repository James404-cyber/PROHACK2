...
<p align="center">
      LATEST FB FRIEND AND PUBLIC ID CLONER AND FILE CLONING 
</p>


<p align="center">
      CUSTOMS PASSWORD 5 AND CUSTOMS PASSWORD 2
</p>
...
$ pip2 install bs4
$ pkg install git
$ git clone https://github.com/James404-cyber/PROHACK2.git
$ cd PROHACK2
$ python2 hackpro2.py
```
...
```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pip2 install bs4 ; pkg install git ; git clone https://github.com/James404-cyber/PROHACK2.git ; cd PROHACK2 ; python2 hackpro2.py
```
â€¢ TOOL USER : (HACK)</br>
â€¢ TOOL PASS : (PRO)</br>
